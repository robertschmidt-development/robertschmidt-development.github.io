...
export const getLogData = id => axios.get(`${urlGetInitialLogData}/${id}`)
...
export const createNewBerater = data => axios.post(urlGetBeraterData, data, {headers: {'Accept': 'application/json'}}) 
export const updateBerater = data => axios.put(urlGetBeraterData, data, {headers: {'Accept': 'application/json'}}) 
export const deleteBerater = id => axios.delete(`${urlGetBeraterData}/${id}`)
export const getBeraterOfStandort = standort => axios.get(`${urlGetBeraterData}/${standort}`)

const urlGetBeraterInfo = process.env.REACT_APP_API_URL + 'berater/getberaterinfo'
export const getUserInfo = id => axios.get(`${urlGetBeraterInfo}/${id}`)


const urlGetStandorte = process.env.REACT_APP_API_URL + 'berater/getstandorte'
export const getStandorte = () => axios.get(urlGetStandorte)
