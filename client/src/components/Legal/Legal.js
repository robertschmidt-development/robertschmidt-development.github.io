    ...
    return <>
            <br />
                <h1>Impressum</h1>
                    ...
                    <p>Sollten Sie Fragen zum Datenschutz haben, finden Sie nachfolgend die Kontaktdaten der verantwortlichen Person bzw. Stelle:<br/>Musterfirma GmbH<br/>
                    ...
                    <br/>Telefon: 01234/56789<br/>Impressum: <a href="https://www.testfirma.at/impressum/" target="_self">https://www.testfirma.at/impressum/</a>
                    <br/>
                    </p>
                    ...
                    <span style={{fontWeight: 400}}>Vertretungsberechtigt: Markus Mustermann</span>
                    <br />
                    ...
                    <ul>
                    <li>die komplette Internetadresse (URL) der aufgerufenen Webseite (z. B. https://www.beispielwebsite.de/beispielunterseite.html?tid=321288915)</li>
                    ...
                    <p>Wenn Sie mehr über Font Awesome und deren Umgang mit Daten erfahren wollen, empfehlen wir Ihnen die Datenschutzerklärung unter <a href="https://fontawesome.com/privacy">https://fontawesome.com/privacy</a> und die Hilfeseite unter <a href="https://fontawesome.com/help?tid=321288915">https://fontawesome.com/help</a>.</p>
                    <h2 id="jquery-cdn-datenschutzerklaerung">jQuery CDN Datenschutzerklärung</h2>
                    ...
                    <p>Wenn Sie nicht wollen, dass es zu einer Datenübertragung kommt, haben Sie immer auch die Möglichkeit Java-Scriptblocker wie beispielsweise <a href="https://www.ghostery.com/de/" target="_blank" rel="follow noopener noreferrer">ghostery.com</a> oder <a href="https://noscript.net/" target="_blank" rel="follow noopener noreferrer">noscript.net</a> zu installieren. Sie können aber auch einfach in Ihrem Browser die Ausführung von JavaScript-Codes deaktivieren. Wenn Sie sich für die Deaktivierung von JavaScript-Codes entscheiden, verändern sich auch die gewohnten Funktionen. So wird beispielsweise eine Website nicht mehr so schnell geladen.</p>
                    <h3>Rechtsgrundlage</h3>
                    <p>Wenn Sie eingewilligt haben, dass jQuery CDN eingesetzt werden darf, ist die Rechtsgrundlage der entsprechenden Datenverarbeitung diese Einwilligung. Diese Einwilligung stellt laut<strong> Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)</strong> die Rechtsgrundlage für die Verarbeitung personenbezogener Daten, wie sie bei der Erfassung durch jQuery CDN vorkommen kann, dar.</p>
                    <p>Von unserer Seite besteht zudem ein berechtigtes Interesse, jQuery CDN zu verwenden, um unser Online-Service zu optimieren und sicherer zu machen. Die dafür entsprechende Rechtsgrundlage ist <strong>Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</strong>. Wir setzen jQuery CDN gleichwohl nur ein, soweit Sie eine Einwilligung erteilt haben.</p>
                    ...
                    <tr>
                    <td>
                    <strong>BootstrapCDN Datenschutzerklärung Zusammenfassung</strong>
                    <br />
                    &#x1f465; Betroffene: Besucher der Website<br />
                    ...
                    <h3>Was ist BootstrapCDN?</h3>
                    <p>Um Ihnen all unsere einzelnen Webseiten (Unterseiten unserer Website) auf allen Geräten schnell und sicher ausliefern zu können, nutzen wir das Content Delivery Network (CDN) BootstrapCDN, ein Open-Source-Dienst von <a href="https://www.jsdelivr.com/" target="_blank" rel="follow noopener noreferrer">jsdelivr.com</a> des polnischen Software-Unternehmens ProspectOne, Królewska 65A/1, 30-081, Kraków, Polen. Ein Content Delivery Network (CDN) ist ein Netzwerk regional verteilter Server, die über das Internet miteinander verbunden sind. Durch dieses Netzwerk können Inhalte, speziell sehr große Dateien, auch bei großen Lastspitzen schnell ausgeliefert werden.</p>
                    <h3>Warum verwenden wir BootstrapCDN?</h3>
